...
for cfg, model_name in models:
    ...
    for bm, benchmark_name in bms.items():
        ...
        # 创建数据记录
        record = {"Model": model_name, "Benchmark": benchmark_name, "Execution_Time": execution_time}
        # print(record)
...
fig.savefig("time_reduction.pdf",dpi=300,format="pdf",bbox_inches='tight', pad_inches=0, facecolor="w")
